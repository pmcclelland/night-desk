...
function an({ debounceSaveMs: e = 100, onlySaveAfterUserInteractions: t, panelIds: n, storage: o = localStorage, ...i }) {
	const s = n !== void 0, u = "id" in i ? i.id : i.groupId, a = he(u, n ?? []), r = (0, import_react.useSyncExternalStore)(Jt, () => o.getItem(a), () => o.getItem(a)), l = (0, import_react.useMemo)(() => {
		if (r) {
...
//#endregion
export { qt as i, an as n, nn as r, Qt as t };
