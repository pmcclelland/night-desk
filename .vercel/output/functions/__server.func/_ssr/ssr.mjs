...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-I8DLeO7s.mjs");
...
var manifest = {
	"12756aea4185bdcb4aa10017af01cc228665ce7bdef96776e2745b2116b55b89": {
		functionName: "cancelAllAlpaca_createServerFn_handler",
		importer: () => import("./trade-Bhp9hFJE.mjs")
	},
	"34cfd8b1a350b921dddb403c14f73122f90926a989eb8b2b302c7115e63cc8c1": {
		functionName: "cancelAlpacaOrder_createServerFn_handler",
		importer: () => import("./trade-Bhp9hFJE.mjs")
	},
	"3aee79f4a822642bd4190df7cd1d921afbf0038e852123b6339df50a26dc44d3": {
		functionName: "fetchBars_createServerFn_handler",
		importer: () => import("./market-CJDbz3gv.mjs")
	},
	"5e0c367001645e2ea4b82ce038a0bf45f05667fa2033ee44a2ee59dd7ef4f3ae": {
		functionName: "fetchQuotes_createServerFn_handler",
		importer: () => import("./market-CJDbz3gv.mjs")
	},
	"883d59fd5489426b66674e567dab3abb00eb33eb9d8e1d1861ddc76696024601": {
		functionName: "submitAlpacaOrder_createServerFn_handler",
		importer: () => import("./trade-Bhp9hFJE.mjs")
	},
	"a38db775eac05c9beaaaf3f87230f6211ff85a0f9480d31ecd904ca58cde431d": {
		functionName: "fetchEquityHistory_createServerFn_handler",
		importer: () => import("./trade-Bhp9hFJE.mjs")
	},
	"a960e657c06549777807cf2fa131137507a123fcb65ed6947791d5ddc5429dc0": {
		functionName: "closeAlpacaPosition_createServerFn_handler",
		importer: () => import("./trade-Bhp9hFJE.mjs")
	},
	"be9aa40168a8df26bd0056c8aa521ad6ac6f1efc283f676bb650b7aabf3e70ef": {
		functionName: "closeAllAlpaca_createServerFn_handler",
		importer: () => import("./trade-Bhp9hFJE.mjs")
	},
	"c0bf3fc535bf25e04517a2179ac179f2f19a8ac8fa704dc2c7f681a27ab933b1": {
		functionName: "askDesk_createServerFn_handler",
		importer: () => import("./grok-yEWrmjct.mjs")
	},
	"cb7af05d17751ac33e65ab421cef3ef500b4ba6675ff32446fd2fd4c9411934b": {
		functionName: "fetchAccountSnapshot_createServerFn_handler",
		importer: () => import("./trade-Bhp9hFJE.mjs")
	},
	"f933f05ada1bd67cc5be98bb37eb9e6c711baf688c265aef5a347421b1596ef0": {
		functionName: "pingAlpaca_createServerFn_handler",
		importer: () => import("./trade-Bhp9hFJE.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BjvZE8p1.mjs").then((n) => n.t),
